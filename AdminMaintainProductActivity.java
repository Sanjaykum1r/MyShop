...
import com.example.mybookshop.Sellers.SellerProductCategoryActivity;
...
public class AdminMaintainProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displaySpecificificProductInfo();
    ...
    private void deleteThisProduct() {
        productsRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                finish();
                Toast.makeText(AdminMaintainProductActivity.this,"The Product is delete successfully",Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void applyChanges()
    {
        ...
        String pdescription=name.getText().toString();
        ...
        else
        {
            ...
            productsRef.updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    {
                        Toast.makeText(AdminMaintainProductActivity.this,"Changes applied successfully... ",Toast.LENGTH_LONG).show();
    ...
    private void displaySpecificificProductInfo()
    {
