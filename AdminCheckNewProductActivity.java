...
public class AdminCheckNewProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unverifiedProducts= FirebaseDatabase.getInstance().getReference().child("Product");
    ...
    private void ChangeProductState(String productId) {
        unverifiedProducts.child(productId).child("ProductState").setValue("Approved").addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(AdminCheckNewProductActivity.this, "That item has been approved, and it is now available for rent from the seller...", Toast.LENGTH_SHORT).show();
